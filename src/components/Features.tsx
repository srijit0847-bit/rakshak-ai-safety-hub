      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="group hover:shadow-xl transition-smooth border-2 hover:border-primary/20 overflow-hidden"
            >
              <CardContent className="p-6 space-y-4">
                {feature.image ? (
                  ...
                  <div
                    className={`w-16 h-16 rounded-2xl flex items-center justify-center transition-smooth group-hover:scale-110 ${
